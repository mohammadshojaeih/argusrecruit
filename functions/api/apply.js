    ...
    function applicantHtml(lang, name, jobTitle) {
      const COPY = {
        en: {
          ...
          p1: 'We have received your CV and a senior recruiter on our team will review it personally. If your background matches the role, we will get in touch within one business day to schedule a confidential conversation.',
        ...
        ru: {
          ...
          p1: 'Мы получили ваше резюме, и старший рекрутер из нашей команды лично его рассмотрит. Если ваш опыт подходит для этой роли, мы свяжемся с вами в течение одного рабочего дня для конфиденциального разговора.',
        ...
        hy: {
          ...
          p1: 'Մենք ստացել ենք ձեր CV-ն, և մեր թիմի ավագ ռեկրուտերն այն անձամբ կքննարկի: Եթե ձեր փորձառությունը համապատասխանում է դերին, մենք կկապվենք ձեզ հետ մեկ աշխատանքային օրվա ընթացքում՝ գաղտնի զրույց պլանավորելու համար:',
